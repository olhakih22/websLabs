...
let ShipOnPiers = [new ShipOnPier([19 ,20], 32), new ShipOnPier([999], 2)]

let ports = [new Port('Ambarli', 'Turkey', 9812, 'Istiklal 2', [32]),
    new Port('New York', 'USA', 1313, 'West 42', []),
    new Port('Paul', 'Spain', 1234, 'Kymprest 1', [])]

let ships = [
    new Ship('Neon', 19, 'Turkey', 39, [
            new Log(18, new Date(2019, 11, 30), new Date(2020, 5, 26)),
                new Log(32, new Date(2020, 3, 30), new Date(2020, 9, 26))
            ]),

    new Ship('Trevi', 20, 'Mumbai', 15,
        [
            new Log(18, new Date(2019, 12, 30), new Date(2020, 5, 17)),
                new Log(2, new Date(2020, 4, 30), new Date(2020, 9, 17))
            ]),
    new Ship('Tutan', 21, "Tokyo", 10,
        [
            new Log(25, new Date(2017, 12, 30), new Date(2028, 5, 17)),
                new Log(26, new Date(2018, 4, 30), new Date(2019, 9, 17))])]

let piers = [new Pier('Brodvey', 32, 5), new Pier('Peep', 27, 9),
    new Pier('Spais', 29, 6)]
